          ...
          <div className='font-lexend mx-auto w-full max-w-7xl px-4 pt-8 pb-12 sm:px-6 lg:px-8 lg:pt-36'>
            ...
            <div className='mt-6 space-y-4 text-gray-300'>
              ...
              <p className='font-lexend mt-4 font-light text-gray-300'>
                ...
                using the Neverland Money platform.
              </p>
            </div>
          </div>
        </section>
        ...
        <article className='mx-auto max-w-7xl px-6 pb-16'>
          ...
          <section id='information-collection' className='mb-12'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              1. Privacy Policy and Related Services
            </h2>
            <div className='space-y-4 leading-relaxed text-gray-100'>
              <p>
                ...
                accordance with this Privacy Policy, we do not have information
                about all protocol users beyond what is already publicly
                available and recorded on the blockchain.
              </p>
              <p>
                This Privacy Policy (the &quot;Privacy Policy&quot;) explains
                how Neverland Money (&quot;we,&quot; &quot;our,&quot; or
                &quot;us&quot;) collects, uses, and shares information in
                connection with our Services as well as your rights and choices
                regarding such information in accordance with applicable data
                protection legislation, including the Data Protection Act (as
                amended) of the Cayman Islands (together, &quot;Data Protection
                Legislation&quot;). These terms apply to Neverland.money and the
                Interface and any other online location that links to this
              ...
              <p>
                ...
                individuals and you should transmit this Privacy Policy to such
          ...
          <section className='mb-12'>
            ...
            <div className='space-y-4 leading-relaxed text-gray-300'>
              ...
              <p>
                <strong>Correspondence and Content:</strong> When you contact us
                for support or other inquiries, you may share with us your
                contact details and contextual information relevant to your
                issue (such as wallet type, token or transaction details, device
                type, or error codes). This helps us respond and improve the
                Services.
              </p>
              <p>
              ...
              <p>
                ...
                that are associated with certain legally prohibited conduct from
                Interface. Separately, we may collect your wallet address as
                part of &quot;Usage Information&quot; (as described below) to
                improve the Interface and user experience of the Services.
              </p>
              <p>
                <strong>Device Information:</strong> We may collect information
                about the device you use to access the Interface, such as the
                device type, operating system, browser type, and screen height
                and width. This information helps us optimize the Interface for
                different devices and troubleshoot any technical issues.
              </p>
              <p>
                ...
                visit, the features and assets you interact with, the links you
                click, and the search queries you make. By analyzing this data,
                we gain a deeper understanding of user behavior, which in turn
                allows us to make continuous improvements to the Interface and
          ...
          <section id='use-of-information' className='mb-12'>
            ...
            <div className='space-y-4 leading-relaxed text-gray-300'>
              <p>
                ...
                otherwise in pursuance of our legitimate interests or those of a
                third party to whom your personal data is disclosed. In
              ...
              <p>
                ...
                the Services available to you and perform services requested by
                you, such as responding to your comments, questions, and
                ...
                messages; detecting, preventing, and addressing fraud, breach of
                Terms, and threats, or harm; and compliance with legal and
                regulatory requirements.
              </p>
              <p>
                <strong>Improving the Services:</strong> To continually improve
                the Services and fulfill any other legitimate business purpose,
              ...
              <p>
                ...
                security or integrity of the Interface, including to prevent or
                stop an attack on our computer systems or networks, investigate
                possible wrongdoing in connection with the Interface, enforce
                our Terms, and comply with applicable laws, lawful requests, and
                legal process.
              </p>
            </div>
          </section>

          <section id='sharing-and-disclosure-of-information' className='mb-12'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
            ...
            <div className='space-y-4 leading-relaxed text-gray-300'>
              ...
              <p>
                ...
                affiliates and related entities, including where they act as our
              ...
              <p>
                ...
                fraud detection and prevention, security threat detection, data
                analytics, information technology and storage, and blockchain
                transaction monitoring.
              </p>
              <p>
                <strong>Regulatory and government authorities:</strong> In
                certain circumstances, we may be legally obliged to share your
                personal data and other information with relevant regulatory or
                governmental authorities.
              </p>
            </div>
          </section>

          <section className='mb-12' id='third-party-services'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
            ...
            <div className='space-y-4 leading-relaxed text-gray-300'>
              ...
              <p>
                Please note that when you interact with other parties, including
                when you leave the Interface, those parties may independently
                collect information about you and solicit information from you.
                The information collected and stored by those parties remains
                subject to their own policies and practices.
              </p>
              <p>
                For example, by using a third-party wallet to engage in
                transactions on public blockchains, your interactions with any
                third-party wallet provider are governed by the applicable terms
                of service and privacy policy of that wallet provider.
              </p>
            </div>
          </section>

          <section className='mb-12' id='cookies-policy'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              6. Cookies Policy
            </h2>
            <div className='space-y-4 leading-relaxed text-gray-300'>
              <p>
                ...
                the spirit of transparency, this Cookies Policy provides
              ...
              <p>
                ...
                other technologies to understand how you use our Interface so we
                can improve its design and functionality.
              </p>
              <h3 className='text-xl font-semibold text-white'>
              ...
              <p>
                ...
                allow us to analyze how visitors use the Interface, which helps
                us improve its functionality and performance.
              </p>
              <p>
          ...
          <section className='mb-12' id='data-security'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              7. Data Security
            </h2>
            <div className='space-y-4 leading-relaxed text-gray-300'>
          ...
          <section className='mb-12' id='data-retention'>
            ...
            <div className='space-y-4 leading-relaxed text-gray-300'>
              <p>
                Please note that we retain information we collect as long as it
                is necessary to fulfill the purpose for which it was collected,
                as outlined in this Privacy Policy, and to the extent permitted
                by applicable legal requirements. Where you request the deletion
                of your information, we may continue to retain and use your
                information as permitted or required under applicable laws.
              </p>
              <p>
          ...
          <section className='mb-12' id='children'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              10. Children
            </h2>
            <div className='space-y-4 leading-relaxed text-gray-300'>
              <p>
                ...
                Privacy Protection Act, or &quot;COPPA&quot;) from children. If
                ...
                contact@neverland.money and we will remove the personal
          ...
          <section className='mb-12' id='changes-to-this-privacy-policy'>
            ...
            <div className='space-y-4 leading-relaxed text-gray-300'>
              <p>
                ...
                doubt, your continued use of the Services indicates your consent
                to the revised Privacy Policy then posted.
              </p>
            </div>
          </section>
