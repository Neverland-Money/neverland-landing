      ...
      <div className='relative z-10'>
        ...
        <section>
          <div className='font-lexend mx-auto w-full max-w-7xl px-4 pt-8 pb-12 sm:px-6 lg:px-8 lg:pt-36'>
            ...
            <div className='mt-6 space-y-4 text-gray-300'>
              <p className='leading-relaxed'>Last updated: July 20, 2025</p>
        ...
        <article className='mx-auto max-w-7xl px-6 pb-16'>
          <section id='welcome' className='mb-12'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              1. Welcome to Neverland Money and the Interface!
            </h2>
            <div className='space-y-4 leading-relaxed'>
              <p>
                These Terms of Use (&quot;Terms&quot;) govern your access to and
                use of both the neverland.money website (referred to as
                &quot;neverland.money&quot;) and our DeFi interface (referred to
                as the &quot;Interface&quot;) collectively referred to as the
                &quot;Services.&quot; The Services are brought to you by
                ...
                protocol called the Neverland Protocol, comprised of open-source
                self-executing smart contracts that are deployed on various
                permissionless public blockchains, such as Monad (the
                &quot;Neverland Protocol&quot; or the &quot;Protocol&quot;).
                Neverland Money does not control or operate any version of the
                Neverland Protocol on any blockchain network. neverland.money
                acts solely as an infrastructure provider for the Protocol and
                does not provide custodial, broker, or financial services to
                users.
              </p>
              <p>
                The Interface provides one of the available applications through
                which users, via their self-custodial wallets, interact with the
                Neverland Protocol.
              </p>
              <p>
                ARBITRATION NOTICE: THESE TERMS CONTAIN AN ARBITRATION CLAUSE
                BELOW. EXCEPT FOR CERTAIN TYPES OF DISPUTES MENTIONED IN THAT
                ARBITRATION CLAUSE, YOU AND WE AGREE THAT ANY DISPUTES RELATING
                TO THE SERVICES WILL BE RESOLVED BY MANDATORY BINDING
              ...
              <p>
                ...
                POLICY, AND OTHER POLICIES REFERENCED HEREIN (COLLECTIVELY, THE
                &quot;AGREEMENT&quot;).
              </p>
            </div>
          </section>
          ...
          <section id='use-of-services' className='mb-12'>
            ...
            <div className='space-y-4 leading-relaxed'>
              <p>
                ...
                individual or entity who is a citizen, resident, or located in a
                jurisdiction where such access or use is restricted or
                prohibited under applicable laws, regulations, or sanctions
                regimes. This includes, without limitation, the United States,
                the United Kingdom, any European Union member state, the Cayman
                Islands, and jurisdictions subject to sanctions imposed by the
                United Nations, the European Union, or the U.S. Office of
                Foreign Assets Control (OFAC).
              </p>
              <p>
                To use Services, you must be at least 18 years old and have full
                legal capacity to enter into binding agreements. If you are
                under the age of 18 or lack the legal capacity, use the Services
                with the explicit permission and supervision of your parent or
                legal guardian. In such cases, your parent or legal guardian
                must read and agree to these Terms on your behalf and will be
                responsible for all activities conducted through Services.
              </p>
              <p>
              ...
              <p>
                ...
                legal entity, you represent and warrant that you have the legal
                authority to bind such entity to these Terms. In such cases, the
                terms &quot;User&quot; &quot;you&quot; and &quot;your&quot;
                shall refer to both you as an individual and the entity you
                represent.
              </p>
              <p>
          ...
          <section id='services' className='mb-12'>
            ...
            <div className='space-y-4 leading-relaxed'>
              <p>
                <strong>Nature of the Service.</strong> neverland.money provides
                an informational Interface to interact with the Neverland
                Protocol. All content, materials, data, and other information
                made available through the Interface are for general
                informational purposes only. While we endeavor to ensure that
                the information is accurate and up to date, we do not warrant or
                guarantee its accuracy, completeness, reliability, suitability,
                or timeliness. You acknowledge that any reliance on the
                information is at your sole risk.
              </p>
              <p>
                <strong>Non Custodial Service.</strong> We do not hold, possess,
                custody, or control any crypto assets, fiat currency, or other
                digital or tangible assets belonging to you or any other user.
              </p>
              <p>
              ...
              <p>
                ...
                Neverland protocol. All wallet software or hardware is developed
              ...
              <p>
                ...
                agent, broker, exchange, clearinghouse, custodian, or financial
                institution with respect to any blockchain transaction you
                effect.
              </p>
              <p>
              ...
              <p>
                <strong>No Financial, Tax or Legal Advice.</strong> The Protocol
                is not registered with any financial regulatory authority in any
                jurisdiction and is not intended to constitute an offer of
                securities or investment services. The Information provided
                through the neverland.money and Interface does not constitute
                financial, investment, tax, legal, or other professional advice,
                and you should not rely on it as such. Users should consult
                independent advisors before engaging with the Protocol. Rewards,
                yields, or returns are not guaranteed and are determined solely
          ...
          <section id='assumption-of-risk' className='mb-12'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
            ...
            <div className='space-y-4 leading-relaxed'>
              ...
              <ul className='ml-6 list-disc space-y-2'>
                ...
                <li>
                  ...
                  blockchain ecosystems, which may fail or evolve unpredictably.
                </li>
                <li>
                  <strong>Regulatory Uncertainty:</strong> Laws governing
                  cryptocurrencies, and blockchain technologies are unsettled
                  and may adversely impact the neverland.money&apos;s operations
                  or your assets.
                </li>
                <li>
                ...
                <li>
                  <strong>Third-Party Dependencies:</strong> The neverland.money
                  relies on third-party services, and disruptions to these
                  services may impair functionality.
                </li>
                <li>
                  ...
                  liquidation are met, liquidation will occur automatically and
              ...
              <p>
                ...
                for keeping your self custodial wallet and all associated
                private keys, seed phrases, passwords, and credentials, secure.
                You agree that you alone bear all risk of loss or theft of your
                crypto assets resulting from unauthorized access to your wallet.
              </p>
              <p>
              ...
              <ul className='ml-6 list-disc space-y-2'>
                <li>
                  Storing private keys offline in hardware wallets or other cold
                  storage solutions;
                </li>
          ...
          <section className='mb-12' id='taxes'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              5. Taxes
            </h2>
            <div className='space-y-4 leading-relaxed'>
              <p>
                <strong>You are responsible for your taxes and duties.</strong>
              </p>
              <p>
                ...
                Services. Blockchain-based transactions are novel, and their tax
                treatment is uncertain.
              </p>
            </div>
          </section>

          <section className='mb-12' id='ownership'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
              6. Ownership
            </h2>
            <div className='space-y-4 leading-relaxed'>
          ...
          <section className='mb-12' id='prohibited-content'>
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
            ...
            <div className='space-y-4 leading-relaxed'>
              <p>
                ...
                applicable third-party policies, and all applicable laws, rules,
                regulations, and related guidance.
              </p>
              <p>The following conduct is prohibited:</p>
              <ul className='ml-6 list-disc space-y-2'>
                <li>
                  Engaging in or promoting any unlawful, fraudulent, or illegal
                  activity
                </li>
                <li>
                ...
                <li>Using the Services under false or fraudulent pretenses</li>
                <li>
          ...
          >
            ...
            <div className='space-y-4 leading-relaxed'>
              ...
              <p>
                ...
                is&quot; and &quot;as available&quot; basis, without any express
                or implied warranties of any kind. We expressly disclaim all
                warranties, whether express, implied, statutory, or otherwise,
                including but not limited to any warranties of merchantability,
                fitness for a particular purpose, non-infringement, title, or
                that the neverland.money&apos;s content or services will be
                accurate, error-free, uninterrupted, secure, or free of harmful
                components. Users are solely responsible for verifying any
                information obtained through the neverland.money before relying
                on it for any purpose. We do not warrant that the
                neverland.money will be continuous, error-free, secure, or free
                of viruses, malware, or other harmful components.
              </p>
              <p>
                <strong>Limitation of Liability.</strong> To the maximum extent
                permitted by law, in no event shall the we, our affiliates,
                officers, directors, employees, contractors, licensors, or
                agents be liable for any direct, indirect, incidental, special,
                consequential, exemplary, or punitive damages, including but not
                limited to lost profits, lost revenues, lost data, business
                interruption, reputational harm, or any other losses arising out
              ...
              <ul className='ml-6 list-disc space-y-2'>
                ...
                <li>
                  Any modifications, discontinuation, suspension, or termination
                  of the neverland.money or its services.
                </li>
              </ul>
              <p>
              ...
              <p>
                ...
                certain damages; in those cases, the limitations shall apply to
          ...
          <section className='mb-12' id='indemnification'>
            ...
            <div className='space-y-4 leading-relaxed'>
              ...
              <p>
                This indemnification applies only to the extent that such claims
                arise from your actions or omissions and not from our negligence
          ...
          <section
            className='mb-12'
            id='arbitration-agreement-and-waiver-of-rights'
          >
            <h2 className='font-cinzel mb-6 border-b border-gray-700 pb-3 text-2xl font-bold text-white'>
            ...
            <div className='space-y-4 leading-relaxed'>
              <p>
                ...
                your use of the neverland.money, both parties (i.e., you and the
                Company) agree to first attempt to resolve the matter through
                good faith negotiations. We encourage open communication and a
                mutual effort to settle any issues before proceeding further.
              </p>
              <p>
                <strong>Mediation.</strong> If a resolution cannot be reached
                through negotiation, both parties agree to submit the dispute to
                mediation. The mediator shall be chosen by mutual agreement. If
                you and the Company are unable to agree on a mediator within a
                reasonable timeframe, the Company will appoint a mediator on
                behalf of both parties. Mediation is intended to be a
                non-binding process aimed at facilitating an amicable
                resolution.
              </p>
              <p>
                <strong>Binding Arbitration.</strong> Any dispute, controversy,
                or claim arising out of or relating to these Terms, including
                their formation, validity, interpretation, performance, breach,
                or termination, shall be finally settled by arbitration under
                the LCIA Arbitration Rules. The seat (legal place) of
              ...
              <p>
                ...
                clauses, this clause does not apply to you and you may have the
                right to bring claims before your local courts.
              </p>
              <p>
                <strong>Language of Proceedings.</strong> All negotiations,
                mediation sessions, and arbitration hearings shall be conducted
                exclusively in the English language.
              </p>
              <p>
                <strong>Time Limit for Claims.</strong> Any claim or cause of
                action arising from or relating to these Terms or the use of the
                neverland.money must be initiated within one (1) year from the
                date the cause of action arises. If a claim is not brought
          ...
          <section className='mb-12' id='termination'>
            ...
            <div className='space-y-4 leading-relaxed'>
              <p>
                ...
                nature should survive termination (e.g., ownership, disclaimers,
                limitations of liability, and arbitration) shall remain in
                effect. You may terminate your Agreement with us at any time by
                ceasing all access to the Services. If, in our sole judgment,
                you fail, or we suspect that you have failed, to comply with any
                term or provision of the Agreement, we reserve the right to
                terminate our Agreement with you and deny you access to the
                Services.
              </p>
              <p>
                WE RESERVE THE RIGHT TO MODIFY THE SERVICES AT ANY TIME, BUT WE
                HAVE NO OBLIGATION TO UPDATE THE SERVICES. YOU AGREE THAT WE MAY
                REMOVE THE SERVICES FOR INDEFINITE PERIODS OF TIME OR CANCEL THE
          ...
          <section className='mb-12' id='contact-information'>
            ...
            <div className='space-y-4 leading-relaxed'>
              <p>
                You may contact us with questions about your use of the Services
                at{' '}
                <a
                  className='text-pink-200 transition-colors hover:text-pink-300 hover:underline'
