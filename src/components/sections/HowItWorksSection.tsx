...
export default function HowItWorksSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: 'Governance',
      description:
        'Help shape the future of Neverland. Vote on proposals and play a key part in the decision making process.',
      side: 'left',
    },
  ];
  ...
  useEffect(() => {
    ...
    return () => {
      currentStepRefs.forEach((el) => el && observer.unobserve(el));
    };
  }, [mounted]);
