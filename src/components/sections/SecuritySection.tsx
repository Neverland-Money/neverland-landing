    ...
    >
      ...
      <div className='relative z-10 flex h-full w-full flex-col items-center justify-center gap-4 lg:gap-8'>
        <div className='flex w-full flex-col items-center gap-2'>
          ...
          <p className='font-quicksand w-full text-center text-xs leading-[140%] text-white/60 sm:text-sm lg:text-base'>
            {description}
          </p>
        </div>
        {!disabled && (
          <Link
            ...
            className='flex h-4 w-[100px] items-center justify-center transition-all duration-300 hover:scale-110 hover:brightness-125 sm:h-5 sm:w-[140px]'
          >
            <svg
              width='140'
              height='20'
    ...
    >
      <FadeInWhenVisible delay={0} y={20}>
        <div className='flex w-full max-w-[539px] flex-col items-center gap-3 px-2'>
          ...
          <p className='font-quicksand w-full max-w-[326px] text-center text-base leading-[140%] text-white lg:text-lg'>
      ...
      <FadeInWhenVisible delay={0} y={20}>
        <div className='flex w-full flex-col items-center justify-center gap-8 lg:flex-row lg:gap-12 xl:gap-16'>
          <SecurityCard
            ...
            href='https://github.com/Neverland-Money/security-audits'
            disabled={false}
