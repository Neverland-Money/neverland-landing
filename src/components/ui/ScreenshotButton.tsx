...
export function ScreenshotButton() {
  ...
  const handleScreenshot = useCallback(async () => {
    ...
    try {
      ...
      link.download = `neverland-${Date.now()}.png`;
  ...
  return (
    <>
      <motion.button
        ...
        aria-label='Take screenshot for X posting'
        whileHover={{
          scale: 1.05,
      ...
      {/* Hidden canvas replica of hero section - uses only inline styles to avoid oklch */}
      <div
        ref={canvasRef}
        style={{
          position: 'fixed',
      ...
      >
        ...
        {/* Combined fade gradient - single div covering full height */}
        <div
          style={{
            position: 'absolute',
            top: 0,
            ...
            bottom: 0,
            background:
              'linear-gradient(to bottom, rgba(0, 0, 0, 0.7) 0%, transparent 42%, transparent 58%, rgba(0, 0, 0, 0.7) 100%)',
            zIndex: 4,
          }}
        />
        ...
        >
          ...
          >
            ...
            <text
              ...
              fontSize='80'
              letterSpacing='0em'
              filter='url(#screenshotTextShadow)'
            >
              <tspan x='0' y='64.16'>
                MAGIC AND PIXIE{' '}
              </tspan>
